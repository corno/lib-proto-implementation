...
export type Address__Selection<Annotation> = (
...
) => g_out.T.Address__Selection

export type Address__Selection__Tail<Annotation> = (
...
) => g_out.T.Address__Selection__Tail
...
export type Resolve<Annotation> = {
    Address__Selection: Address__Selection<Annotation>
    Address__Selection__Tail: Address__Selection__Tail<Annotation>
